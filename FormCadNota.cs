...
namespace Assistencia_Técnica
{
    public partial class FormCadNota : Form
    {
        ...
        DataTable tabelaOS = new DataTable();
        ...
        private void FormCadOS_Load(object sender, EventArgs e)
        {
            ...
            tabelaOS.Columns.Add("Tipo");
            tabelaOS.Columns.Add("ID");
            tabelaOS.Columns.Add("Descricao");
            tabelaOS.Columns.Add("Quantidade");
            tabelaOS.Columns.Add("Estoque");
            tabelaOS.Columns.Add("Preco");
            tabelaOS.Columns.Add("PrecoTotal");

            dataGridOS.DataSource = tabelaOS;
        ...
        private void nomeCliente_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (nomeCliente.SelectedItem.ToString() != string.Empty)
            {
                ...
                conexaoDB.ClienteOS(nomeCliente.SelectedItem.ToString(), ref cliente, ref endCli, ref conCli);
        ...
        private void nomeFun_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (nomeFun.SelectedItem.ToString() != string.Empty)
            {
                ...
                //obtendo os dados do cliente do banco de dados
                MySqlConexao conexaoDB = new MySqlConexao();
                conexaoDB.FuncionariosOS(nomeFun.SelectedItem.ToString(), ref funcionario, ref endFun, ref conFun);
                ...
                case "cliente":
                    {
                        ...
                        conexaoDB.ClienteOS(dados.Cells["Nome"].Value.ToString(), ref cliente, ref endCli, ref conCli);
                        nomeCliente.Text = cliente.Nome;
                        rgCliente.Text = cliente.RG;
                        rgCliente.BackColor = Color.LightGray;
                ...
                case "funcionario":
                    {
                        ...
                        MySqlConexao conexaoDB = new MySqlConexao();
                        conexaoDB.FuncionariosOS(dados.Cells["Nome"].Value.ToString(), ref funcionario, ref endFun, ref conFun);
                ...
                case "produto":
                    {
                        ...
                        //adiciona na lista
                        produtos.Add(novo);
                        DataRow linhaProduto = tabelaOS.NewRow();
                        ...
                        tabelaOS.Rows.Add(linhaProduto);
                        attPrecoOS();
                        break;
                    }
                ...
                case "servico":
                    {
                        ...
                        //adiciona na lista
                        servicos.Add(novo);
                        DataRow linhaServico = tabelaOS.NewRow();
                        ...
                        tabelaOS.Rows.Add(linhaServico);
                        attPrecoOS();
                        break;
                    }
                ...
                && e.RowIndex >= 0)
            {
                ...
                { //clicou no botao de excluir
                    ...
                    if (MessageBox.Show("Tem certeza de que deseja excluir ?", "", MessageBoxButtons.YesNo, MessageBoxIcon.Information) == DialogResult.Yes)
                    {
                        ...
                        DataRow linha = tabelaOS.Rows[e.RowIndex];
        ...
        {
            //atualiza a tabela
            foreach(DataRow linha in tabelaOS.Rows)
            {
